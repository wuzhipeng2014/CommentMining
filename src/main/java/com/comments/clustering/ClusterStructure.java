...
public class ClusterStructure {
     ...
     * @return 扩展后的簇
     */
    private Cluster expandCluster(Neighbors nearNeighbors, final Cluster cluster, final Text instance,
            final List<Text> neighbors, final List<Text> points, final Map<Text, InstanceStatus> visited,
            int clusterLabel) {
